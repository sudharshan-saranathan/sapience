...
Q_CONSTINIT static const uint qt_meta_data_CLASSnodeControlENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       6,    0,   48,    4, 0x109,    3 /* Protected | MethodIsConst  */,
       7,    3,   49,    4, 0x09,    4 /* Protected */,
      11,    2,   56,    4, 0x09,    8 /* Protected */,
...
void nodeControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (nodeControl::*)();
            if (_t _q_method = &nodeControl::updateLink; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
