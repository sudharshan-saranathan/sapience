...
Q_CONSTINIT static const uint qt_meta_data_CLASSnodeCtrlENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       3,    0,  118,    4, 0x06,    1 /* Public */,
       5,    0,  119,    4, 0x06,    2 /* Public */,
       6,    0,  120,    4, 0x06,    3 /* Public */,
       7,    0,  121,    4, 0x06,    4 /* Public */,
       8,    1,  122,    4, 0x06,    5 /* Public */,
      10,    0,  125,    4, 0x06,    7 /* Public */,
      11,    0,  126,    4, 0x06,    8 /* Public */,
      12,    2,  127,    4, 0x06,    9 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      14,    2,  132,    4, 0x09,   12 /* Protected */,
      19,    3,  137,    4, 0x09,   15 /* Protected */,
      23,    1,  144,    4, 0x09,   19 /* Protected */,
      25,    1,  147,    4, 0x09,   21 /* Protected */,
      26,    1,  150,    4, 0x09,   23 /* Protected */,
      27,    1,  153,    4, 0x09,   25 /* Protected */,
      30,    1,  156,    4, 0x09,   27 /* Protected */,
      31,    1,  159,    4, 0x09,   29 /* Protected */,
      32,    1,  162,    4, 0x09,   31 /* Protected */,
 ...
 // signals: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 9, 0x80000000 | 13,    4,    4,

 // slots: parameters
    0x80000000 | 15, 0x80000000 | 16, 0x80000000 | 15,   17,   18,
    QMetaType::Void, 0x80000000 | 20, 0x80000000 | 21, 0x80000000 | 22,    4,    4,    4,
...
void nodeCtrl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 10: _t->hoverMoveEvent((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneHoverEvent*>>(_a[1]))); break;
        case 11: _t->hoverEnterEvent((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneHoverEvent*>>(_a[1]))); break;
        case 12: _t->hoverLeaveEvent((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneHoverEvent*>>(_a[1]))); break;
        case 13: _t->mousePressEvent((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        case 14: _t->mouseDoubleClickEvent((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        ...
        {
            using _t = void (nodeCtrl::*)();
            if (_t _q_method = &nodeCtrl::nodeRenamed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (nodeCtrl::*)();
            if (_t _q_method = &nodeCtrl::nodeRefresh; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
